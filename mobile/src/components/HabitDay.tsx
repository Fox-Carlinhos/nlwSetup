...
import { Alert, Dimensions, TouchableOpacity, TouchableOpacityProps, View } from "react-native";
import { generateProgressPercentage } from "../utils/generate-progress-percentage";

const WEEK_DAYS = 7;
const SCREEN_HORIZONTAN_PADDING = (32 * 2) / 5;

export const DAY_MARGIN_BETWEEN = 8;
export const DAY_SIZE =
  Dimensions.get("screen").width / WEEK_DAYS - (SCREEN_HORIZONTAN_PADDING + 5);
  ...
  return (
    <TouchableOpacity
      className={clsx("rounded-lg border-2 m-1", {
        ...
        ["bg-violet-600 border-violet-400"]: amountAccomplishedPercentage >= 80,
